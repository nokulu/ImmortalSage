...
record RandomGroup(SimpleWeightedRandomList<List<PoolAliasBinding>> groups) implements PoolAliasBinding {
    ...
    @Override
    public void forEachResolved(RandomSource pRandom, BiConsumer<ResourceKey<StructureTemplatePool>, ResourceKey<StructureTemplatePool>> pStucturePoolKey) {
        this.groups.getRandom(pRandom).ifPresent(p_327489_ -> p_327489_.data().forEach(p_313096_ -> p_313096_.forEachResolved(pRandom, pStucturePoolKey)));
    }

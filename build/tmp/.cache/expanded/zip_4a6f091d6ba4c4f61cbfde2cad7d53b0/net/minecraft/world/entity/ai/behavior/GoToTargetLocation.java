        ...
        return BehaviorBuilder.create(
            p_259997_ -> p_259997_.group(
                    ...
                    .apply(p_259997_, (p_259831_, p_259115_, p_259521_, p_259223_) -> (p_341305_, p_341306_, p_341307_) -> {
                            ...
                            boolean flag = blockpos.closerThan(p_341306_.blockPosition(), (double)pCloseEnoughDist);
                            if (!flag) {
                                BehaviorUtils.setWalkAndLookTargetMemories(p_341306_, getNearbyPos(p_341306_, blockpos), pSpeedModifier, pCloseEnoughDist);
                            }

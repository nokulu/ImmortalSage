...
public record WrittenBookContent(Filterable<String> title, String author, int generation, List<Filterable<Component>> pages, boolean resolved)
    ...
    public WrittenBookContent withReplacedPages(List<Filterable<Component>> pNewPages) {
        return new WrittenBookContent(this.title, this.author, this.generation, pNewPages, false);
    }

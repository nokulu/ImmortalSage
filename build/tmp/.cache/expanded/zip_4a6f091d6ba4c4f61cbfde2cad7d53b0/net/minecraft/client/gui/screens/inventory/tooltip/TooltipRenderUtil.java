...
public class TooltipRenderUtil {
    ...
    public static void renderTooltipBackground(GuiGraphics pGuiGraphics, int pX, int pY, int pWidth, int pHeight, int pZ, int backgroundTop, int backgroundBottom, int borderTop, int borderBottom) {
        ...
        renderRectangleGradient(pGuiGraphics, i, j, k, l, pZ, backgroundTop, backgroundBottom);
    ...
    private static void renderRectangleGradient(GuiGraphics pGuiGraphics, int pX, int pY, int pWidth, int pHeight, int pZ, int pColor, int colorTo) {

...
public class GameTestServer extends MinecraftServer {
    ...
    public static GameTestServer create(
        ...
        if (pTestBatches.isEmpty()) {
            ...
            WorldDataConfiguration worlddataconfiguration = new WorldDataConfiguration(
                new DataPackConfig(new ArrayList<>(pPackRepository.getSelectedIds()), List.of()), FeatureFlags.REGISTRY.allFlags() // Forge: Use the selected datapacks as this takes sorting into account.
            );
    ...
    public void onServerCrash(CrashReport pReport) {
        ...
        LOGGER.error("Game test server crashed\n{}", pReport.getFriendlyReport(ReportType.CRASH));
        System.exit(1);
    }

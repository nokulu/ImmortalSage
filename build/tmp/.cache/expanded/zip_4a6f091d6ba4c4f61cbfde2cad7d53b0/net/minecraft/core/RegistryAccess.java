...
public interface RegistryAccess extends HolderLookup.Provider {
    ...
    static RegistryAccess.Frozen fromRegistryOfRegistries(final Registry<? extends Registry<?>> pRegistryOfRegistries) {
        return new RegistryAccess.Frozen() {
            /**
             * Get the registry owned by this registry access by the given key. If it doesn't exist, the default
             * registry of registries is queried instead, which contains static registries such as blocks.

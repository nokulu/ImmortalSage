...
public abstract class PropertyDispatch {
    ...
    public static class C1<T1 extends Comparable<T1>> extends PropertyDispatch {
        ...
        public PropertyDispatch generate(Function<T1, Variant> pPropertyValueToVariantMapper) {
            this.property1.getPossibleValues().forEach(p_125340_ -> this.select((T1)p_125340_, pPropertyValueToVariantMapper.apply((T1)p_125340_)));
            return this;
        }

        public PropertyDispatch generateList(Function<T1, List<Variant>> pPropertyValueToVariantsMapper) {
            this.property1.getPossibleValues().forEach(p_176312_ -> this.select((T1)p_176312_, pPropertyValueToVariantsMapper.apply((T1)p_176312_)));
            return this;
        }
    }
            ...
            this.property1
                ...
                .forEach(
                    p_125376_ -> this.property2
                            .getPossibleValues()
                            .forEach(p_176322_ -> this.select((T1)p_125376_, (T2)p_176322_, pPropertyValuesToVariantMapper.apply((T1)p_125376_, (T2)p_176322_)))
                );
            return this;
        }
            ...
            this.property1
                ...
                .forEach(
                    p_125366_ -> this.property2
                            .getPossibleValues()
                            .forEach(p_176318_ -> this.select((T1)p_125366_, (T2)p_176318_, pPropertyValuesToVariantsMapper.apply((T1)p_125366_, (T2)p_176318_)))
                );
            return this;
        }
    }
                                ...
                                p_176343_ -> this.property3
                                        ...
                                        .forEach(
                                            p_176339_ -> this.select(
                                                    ...
                                                    (T2)p_176343_,
                                                    (T3)p_176339_,
                                                    pPropertyValuesToVariantMapper.apply((T1)p_125404_, (T2)p_176343_, (T3)p_176339_)
                                                )
                                        )
                            )
                );
                                ...
                                p_176331_ -> this.property3
                                        ...
                                        .forEach(
                                            p_176327_ -> this.select(
                                                    ...
                                                    (T2)p_176331_,
                                                    (T3)p_176327_,
                                                    pPropertyValuesToVariantsMapper.apply((T1)p_176334_, (T2)p_176331_, (T3)p_176327_)
                                                )
                                        )
                            )
                );
                                            ...
                                            p_176376_ -> this.property4
                                                    ...
                                                    .forEach(
                                                        p_176371_ -> this.select(
                                                                ...
                                                                (T3)p_176376_,
                                                                (T4)p_176371_,
                                                                pPropertyValuesToVariantMapper.apply((T1)p_176385_, (T2)p_176380_, (T3)p_176376_, (T4)p_176371_)
                                                            )
                                                    )
                                        )
                            )
                                            ...
                                            p_176356_ -> this.property4
                                                    ...
                                                    .forEach(
                                                        p_176351_ -> this.select(
                                                                ...
                                                                (T3)p_176356_,
                                                                (T4)p_176351_,
                                                                pPropertyValuesToVariantsMapper.apply((T1)p_176365_, (T2)p_176360_, (T3)p_176356_, (T4)p_176351_)
                                                            )
                                                    )
                                        )
                            )

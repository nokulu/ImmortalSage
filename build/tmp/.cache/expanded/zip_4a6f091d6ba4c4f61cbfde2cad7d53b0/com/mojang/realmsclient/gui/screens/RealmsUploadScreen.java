...
public class RealmsUploadScreen extends RealmsScreen {
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        if (acomponent != null) {
            for (int i = 0; i < acomponent.length; i++) {
                pGuiGraphics.drawCenteredString(this.font, acomponent[i], this.width / 2, 110 + 12 * i, -65536);
            }
        }
    }
    ...
    private void drawUploadSpeed0(GuiGraphics pGuiGraphics, long pBytesPerSecond) {
        ...
        if (pBytesPerSecond > 0L && s != null) {
            ...
            pGuiGraphics.drawString(this.font, s1, this.width / 2 + i / 2 + 15, 84, -1, false);
        }
    }
        ...
        if (!this.cancelled) {
            ...
            if (file1.isFile()) {
                try (InputStream inputstream = new FileInputStream(file1)) {
                    inputstream.transferTo(pTarArchiveOutputStream);
                }

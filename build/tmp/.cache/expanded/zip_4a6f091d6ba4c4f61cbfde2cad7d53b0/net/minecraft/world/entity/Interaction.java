...
public class Interaction extends Entity implements Attackable, Targeting {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder pBuilder) {
        pBuilder.define(DATA_WIDTH_ID, 1.0F);
        pBuilder.define(DATA_HEIGHT_ID, 1.0F);
        pBuilder.define(DATA_RESPONSE_ID, false);
    }
    ...
    protected void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (this.attack != null) {
            Interaction.PlayerAction.CODEC.encodeStart(NbtOps.INSTANCE, this.attack).ifSuccess(p_272806_ -> pCompound.put("attack", p_272806_));
        }

        if (this.interaction != null) {
            Interaction.PlayerAction.CODEC
                .encodeStart(NbtOps.INSTANCE, this.interaction)
                .ifSuccess(p_272925_ -> pCompound.put("interaction", p_272925_));
        }

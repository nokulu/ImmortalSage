...
public class Pillager extends AbstractIllager implements CrossbowAttackMob, InventoryCarrier {
    ...
    protected void enchantSpawnedWeapon(ServerLevelAccessor pLevel, RandomSource pRandom, DifficultyInstance pDifficulty) {
        ...
        if (pRandom.nextInt(300) == 0) {
            ...
            if (itemstack.is(Items.CROSSBOW)) {
                EnchantmentHelper.enchantItemFromProvider(itemstack, pLevel.registryAccess(), VanillaEnchantmentProviders.PILLAGER_SPAWN_CROSSBOW, pDifficulty, pRandom);
            }
        }
    }
    ...
    public void applyRaidBuffs(ServerLevel pLevel, int pWave, boolean pUnused) {
        ...
        if (flag) {
            ...
            if (resourcekey != null) {
                EnchantmentHelper.enchantItemFromProvider(itemstack, pLevel.registryAccess(), resourcekey, pLevel.getCurrentDifficultyAt(this.blockPosition()), this.getRandom());

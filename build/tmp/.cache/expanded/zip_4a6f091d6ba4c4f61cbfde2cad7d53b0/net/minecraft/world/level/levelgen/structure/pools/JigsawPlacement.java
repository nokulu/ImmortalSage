                    ...
                    p_341930_ -> {
                        ...
                        if (pMaxDepth > 0) {
                            AABB aabb = new AABB(
                                ...
                                (double)Math.max(i1 - pMaxDistanceFromCenter, levelheightaccessor.getMinBuildHeight() + pDimensionPadding.bottom()),
                                (double)(j - pMaxDistanceFromCenter),
                                (double)(i + pMaxDistanceFromCenter + 1),
                                (double)Math.min(i1 + pMaxDistanceFromCenter + 1, levelheightaccessor.getMaxBuildHeight() - pDimensionPadding.top()),

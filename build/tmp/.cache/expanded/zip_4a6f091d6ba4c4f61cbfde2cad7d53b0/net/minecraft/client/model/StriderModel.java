...
public class StriderModel<T extends Strider> extends HierarchicalModel<T> {
    ...
    public void setupAnim(Strider pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        this.body.y = 2.0F;
        this.body.y = this.body.y - 2.0F * Mth.cos(pLimbSwing * 1.5F) * 2.0F * pLimbSwingAmount;
        ...
        float f2 = 1.0F;
        float f3 = 1.0F;
        this.rightBottomBristle.zRot = this.rightBottomBristle.zRot + 0.05F * Mth.sin(pAgeInTicks * 1.0F * -0.4F);
        this.rightMiddleBristle.zRot = this.rightMiddleBristle.zRot + 0.1F * Mth.sin(pAgeInTicks * 1.0F * 0.2F);
        this.rightTopBristle.zRot = this.rightTopBristle.zRot + 0.1F * Mth.sin(pAgeInTicks * 1.0F * 0.4F);
        this.leftTopBristle.zRot = this.leftTopBristle.zRot + 0.1F * Mth.sin(pAgeInTicks * 1.0F * 0.4F);
        this.leftMiddleBristle.zRot = this.leftMiddleBristle.zRot + 0.1F * Mth.sin(pAgeInTicks * 1.0F * 0.2F);
        this.leftBottomBristle.zRot = this.leftBottomBristle.zRot + 0.05F * Mth.sin(pAgeInTicks * 1.0F * -0.4F);
    }

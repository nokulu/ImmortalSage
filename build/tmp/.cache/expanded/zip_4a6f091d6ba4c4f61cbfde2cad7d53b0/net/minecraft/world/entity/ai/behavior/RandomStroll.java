...
public class RandomStroll {
    ...
    public static OneShot<PathfinderMob> stroll(float pSpeedModifier, boolean pMayStrollFromWater) {
        return strollFlyOrSwim(pSpeedModifier, p_258601_ -> LandRandomPos.getPos(p_258601_, 10, 7), pMayStrollFromWater ? p_258615_ -> true : p_341353_ -> !p_341353_.isInWaterOrBubble());
    }

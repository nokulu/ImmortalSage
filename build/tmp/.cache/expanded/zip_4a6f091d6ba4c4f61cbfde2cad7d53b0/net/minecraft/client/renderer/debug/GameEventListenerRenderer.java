    ...
    public void render(PoseStack pPoseStack, MultiBufferSource pBufferSource, double pCamX, double pCamY, double pCamZ) {
        ...
        if (level == null) {
                    ...
                    .ifPresent(
                        p_274713_ -> {
                            DebugRenderer.renderFloatingText(
                                pPoseStack, pBufferSource, "Listener Origin", p_274713_.x(), p_274713_.y() + 1.8F, p_274713_.z(), -1, 0.025F
                            );
                            DebugRenderer.renderFloatingText(
                                pPoseStack,
                                pBufferSource,
            ...
            for (GameEventListenerRenderer.TrackedGameEvent gameeventlistenerrenderer$trackedgameevent : this.trackedGameEvents) {
                ...
                renderFilledBox(pPoseStack, pBufferSource, new AABB(d1, d2, d3, d4, d5, d6), 1.0F, 1.0F, 1.0F, 0.2F);
                DebugRenderer.renderFloatingText(
                    pPoseStack,
                    pBufferSource,

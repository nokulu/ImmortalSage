...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
    ...
    public void onDisconnect(DisconnectionDetails pDetails) {
        ...
        if (this.serverData != null && this.serverData.isRealm()) {
            this.minecraft.setScreen(new DisconnectedRealmsScreen(this.parent, component, pDetails.reason()));
        } else if (net.minecraftforge.client.ForgeHooksClient.onClientDisconnect(this.connection, this.minecraft, this.parent, pDetails.reason())) {
        } else {
            this.minecraft.setScreen(new DisconnectedScreen(this.parent, component, pDetails));
        }
    }
    ...
    public void fillListenerSpecificCrashDetails(CrashReport pCrashReport, CrashReportCategory pCategory) {
        pCategory.setDetail("Server type", () -> this.serverData != null ? this.serverData.type().toString() : "<unknown>");
        pCategory.setDetail("Login phase", () -> this.state.get().toString());
    }

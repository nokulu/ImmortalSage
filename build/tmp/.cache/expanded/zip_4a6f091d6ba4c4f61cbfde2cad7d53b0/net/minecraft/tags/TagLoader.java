...
public class TagLoader<T> {
    ...
    static record SortingEntry(List<TagLoader.EntryWithSource> entries) implements DependencySorter.Entry<ResourceLocation> {
        ...
        public void visitRequiredDependencies(Consumer<ResourceLocation> pVisitor) {
            this.entries.forEach(p_285236_ -> p_285236_.entry.visitRequiredDependencies(pVisitor));
        }

        @Override
        public void visitOptionalDependencies(Consumer<ResourceLocation> pVisitor) {
            this.entries.forEach(p_284943_ -> p_284943_.entry.visitOptionalDependencies(pVisitor));
        }
    }
}

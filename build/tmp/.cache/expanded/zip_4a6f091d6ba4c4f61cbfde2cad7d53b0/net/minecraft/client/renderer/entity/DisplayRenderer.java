    ...
    public static class TextDisplayRenderer extends DisplayRenderer<Display.TextDisplay, Display.TextDisplay.TextRenderState> {
        ...
        public void renderInner(
            ...
            if (i != 0) {
                ...
                vertexconsumer.addVertex(matrix4f, -1.0F, (float)l, 0.0F).setColor(i).setLight(pLightmapUV);
                vertexconsumer.addVertex(matrix4f, (float)k, (float)l, 0.0F).setColor(i).setLight(pLightmapUV);
                vertexconsumer.addVertex(matrix4f, (float)k, -1.0F, 0.0F).setColor(i).setLight(pLightmapUV);
            }

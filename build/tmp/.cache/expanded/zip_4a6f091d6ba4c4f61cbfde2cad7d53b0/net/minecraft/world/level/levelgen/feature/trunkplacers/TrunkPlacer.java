...
public abstract class TrunkPlacer {
    ...
    protected static void setDirtAt(
        ...
        var levelReader = (net.minecraft.world.level.LevelReader)pLevel;
        if (!levelReader.getBlockState(pPos).onTreeGrow(levelReader, pBlockSetter, pRandom, pPos, pConfig))

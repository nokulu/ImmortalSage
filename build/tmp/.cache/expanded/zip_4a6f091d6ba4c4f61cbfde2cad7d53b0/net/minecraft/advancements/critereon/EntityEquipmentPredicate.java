...
public record EntityEquipmentPredicate(
    ...
    public static EntityEquipmentPredicate captainPredicate(HolderGetter<BannerPattern> pPatternRegistry) {
        return EntityEquipmentPredicate.Builder.equipment()
            .head(
                ItemPredicate.Builder.item().of(Items.WHITE_BANNER).hasComponents(DataComponentPredicate.allOf(Raid.getLeaderBannerInstance(pPatternRegistry).getComponents()))
            )
            .build();
    }

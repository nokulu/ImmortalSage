...
public class TextureMapping {
    ...
    public static TextureMapping column(Block pColumnBlock) {
        return new TextureMapping()
            .put(TextureSlot.SIDE, getBlockTexture(pColumnBlock, "_side"))
    ...
    public static TextureMapping door(Block pDoorBlock) {
        return new TextureMapping()
            .put(TextureSlot.TOP, getBlockTexture(pDoorBlock, "_top"))
            .put(TextureSlot.BOTTOM, getBlockTexture(pDoorBlock, "_bottom"));
    }
    ...
    public static TextureMapping vault(Block pVaultBlock, String pFrontSuffix, String pSideSuffix, String pTopSuffix, String pBottomSuffix) {
        return new TextureMapping()
            .put(TextureSlot.FRONT, getBlockTexture(pVaultBlock, pFrontSuffix))
            .put(TextureSlot.SIDE, getBlockTexture(pVaultBlock, pSideSuffix))
            .put(TextureSlot.TOP, getBlockTexture(pVaultBlock, pTopSuffix))
            .put(TextureSlot.BOTTOM, getBlockTexture(pVaultBlock, pBottomSuffix));
    }
    ...
    public static TextureMapping campfire(Block pCampfireBlock) {
        return new TextureMapping()
            .put(TextureSlot.LIT_LOG, getBlockTexture(pCampfireBlock, "_log_lit"))
            .put(TextureSlot.FIRE, getBlockTexture(pCampfireBlock, "_fire"));
    }

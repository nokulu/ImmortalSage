...
public record AdvancementRewards(int experience, List<ResourceKey<LootTable>> loot, List<ResourceLocation> recipes, Optional<CacheableFunction> function) {
    ...
    public void grant(ServerPlayer pPlayer) {
        ...
        this.function
            ...
            .ifPresent(
                p_325189_ -> minecraftserver.getFunctions().execute((CommandFunction<CommandSourceStack>)p_325189_, pPlayer.createCommandSourceStack().withSuppressedOutput().withPermission(2))
            );
    }

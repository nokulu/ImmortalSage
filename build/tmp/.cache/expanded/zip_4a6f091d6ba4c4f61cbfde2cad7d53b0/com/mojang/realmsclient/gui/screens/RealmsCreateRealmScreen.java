...
public class RealmsCreateRealmScreen extends RealmsScreen {
    ...
    private void createWorld(RealmsServer pRealmsServer) {
        RealmCreationTask realmcreationtask = new RealmCreationTask(pRealmsServer.id, this.nameBox.getValue(), this.descriptionBox.getValue());
        RealmsResetWorldScreen realmsresetworldscreen = RealmsResetWorldScreen.forNewRealm(
            this, pRealmsServer, realmcreationtask, () -> this.minecraft.execute(() -> {
                    ...
                    this.minecraft
                        .setScreen(
                            new RealmsLongRunningMcoTaskScreen(
                                this, new CreateSnapshotRealmTask(this.lastScreen, pParentId, p_308056_, this.nameBox.getValue(), this.descriptionBox.getValue())
                            )
                        );
                }
            },

...
public class BlockModelGenerators {
                        ...
                        PropertyDispatch.property(BlockStateProperties.AGE_7)
                            .generate(
                                p_176108_ -> Variant.variant()
                                        .with(
                                            VariantProperties.MODEL,
                                            ModelTemplates.STEMS[p_176108_].create(pUnattachedStemBlock, texturemapping, this.modelOutput)
                                        )
                            )
                    )
            );
                ...
                PropertyDispatch.properties(BlockStateProperties.LIT, BlockStateProperties.POWERED)
                    .generate(
                        (p_308505_, p_308506_) -> p_308505_
                                ? Variant.variant().with(VariantProperties.MODEL, p_308506_ ? pLitPowered : pUnlitPowered)
                                : Variant.variant().with(VariantProperties.MODEL, p_308506_ ? pLit : pUnlit)
                    )
            );
    }
    ...
    class BlockEntityModelGenerator {
        ...
        public BlockEntityModelGenerator(final ResourceLocation pBaseModel, final Block pParticleBlock) {

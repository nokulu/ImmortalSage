...
public class ModelTemplates {
    ...
    private static ModelTemplate create(String pBlockModelLocation, TextureSlot... pRequiredSlots) {
        return new ModelTemplate(Optional.of(ResourceLocation.withDefaultNamespace("block/" + pBlockModelLocation)), Optional.empty(), pRequiredSlots);
    }

    private static ModelTemplate createItem(String pItemModelLocation, TextureSlot... pRequiredSlots) {
        return new ModelTemplate(Optional.of(ResourceLocation.withDefaultNamespace("item/" + pItemModelLocation)), Optional.empty(), pRequiredSlots);
    }

    private static ModelTemplate create(String pBlockModelLocation, String pSuffix, TextureSlot... pRequiredSlots) {
        return new ModelTemplate(Optional.of(ResourceLocation.withDefaultNamespace("block/" + pBlockModelLocation)), Optional.of(pSuffix), pRequiredSlots);
    }
}
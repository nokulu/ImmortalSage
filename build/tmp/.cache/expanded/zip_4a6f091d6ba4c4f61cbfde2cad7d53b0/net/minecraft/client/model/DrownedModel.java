...
public class DrownedModel<T extends Zombie> extends ZombieModel<T> {
    ...
    public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        if (this.swimAmount > 0.0F) {
            ...
            this.leftLeg.xRot = this.leftLeg.xRot - this.swimAmount * 0.55F * Mth.sin(0.1F * pAgeInTicks);
            this.rightLeg.xRot = this.rightLeg.xRot + this.swimAmount * 0.55F * Mth.sin(0.1F * pAgeInTicks);
            this.head.xRot = 0.0F;
        }
    }
}
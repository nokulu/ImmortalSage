...
public class DecoratedPotRenderer implements BlockEntityRenderer<DecoratedPotBlockEntity> {
    ...
    public void render(DecoratedPotBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
        pPoseStack.pushPose();
        ...
        this.renderSide(this.frontSide, pPoseStack, pBufferSource, pPackedLight, pPackedOverlay, getSideMaterial(potdecorations.front()));
        this.renderSide(this.backSide, pPoseStack, pBufferSource, pPackedLight, pPackedOverlay, getSideMaterial(potdecorations.back()));
        this.renderSide(this.leftSide, pPoseStack, pBufferSource, pPackedLight, pPackedOverlay, getSideMaterial(potdecorations.left()));
        this.renderSide(this.rightSide, pPoseStack, pBufferSource, pPackedLight, pPackedOverlay, getSideMaterial(potdecorations.right()));
        pPoseStack.popPose();
    }

                    ...
                    .apply(
                        ...
                        (p_258484_, p_258485_, p_258486_, p_258487_, p_258488_, p_258489_, p_258490_) -> (p_341340_, p_341341_, p_341342_) -> {
                                p_341340_.getPoiManager()
                                    ...
                                    .filter(p_341345_ -> p_341345_.closerToCenterThan(p_341341_.position(), (double)pCloseEnoughDist))
                                    .or(
                                        () -> p_341340_.getPoiManager()
                                                .getRandom(
                                    ...
                                    .ifPresent(p_341328_ -> {
                                        ...
                                        if (!p_341328_.closerToCenterThan(p_341341_.position(), (double)pCloseEnoughDist)) {
                                            p_258484_.set(new WalkTarget(p_341328_, pSpeedModifier, pCloseEnoughDist));
                                        }
                                    });
                                return true;
                            }

...
public abstract class AbstractSchoolingFish extends AbstractFish {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pSpawnType, @Nullable SpawnGroupData pSpawnGroupData) {
        ...
        if (pSpawnGroupData == null) {
            pSpawnGroupData = new AbstractSchoolingFish.SchoolSpawnGroupData(this);
        } else {
            this.startFollowing(((AbstractSchoolingFish.SchoolSpawnGroupData)pSpawnGroupData).leader);
        }

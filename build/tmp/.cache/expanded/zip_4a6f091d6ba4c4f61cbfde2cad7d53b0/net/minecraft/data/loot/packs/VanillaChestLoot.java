...
public record VanillaChestLoot(HolderLookup.Provider registries) implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> pOutput) {
        ...
        pOutput.accept(BuiltInLootTables.BASTION_BRIDGE, this.bastionBridgeLootTable());
        pOutput.accept(BuiltInLootTables.BASTION_HOGLIN_STABLE, this.bastionHoglinStableLootTable());
        pOutput.accept(BuiltInLootTables.BASTION_OTHER, this.bastionOtherLootTable());
        pOutput.accept(BuiltInLootTables.BASTION_TREASURE, this.bastionTreasureLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.ANCIENT_CITY, this.ancientCityLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.DESERT_PYRAMID, this.desertPyramidLootTable());
        pOutput.accept(BuiltInLootTables.END_CITY_TREASURE, this.endCityTreasureLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.JUNGLE_TEMPLE, this.jungleTempleLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.NETHER_BRIDGE, this.netherBridgeLootTable());
        pOutput.accept(BuiltInLootTables.PILLAGER_OUTPOST, this.pillagerOutpostLootTable());
        pOutput.accept(BuiltInLootTables.SHIPWRECK_MAP, this.shipwreckMapLootTable());
        pOutput.accept(BuiltInLootTables.SHIPWRECK_SUPPLY, this.shipwreckSupplyLootTable());
        pOutput.accept(BuiltInLootTables.SHIPWRECK_TREASURE, this.shipwreckTreasureLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.STRONGHOLD_CORRIDOR, this.strongholdCorridorLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.STRONGHOLD_LIBRARY, this.strongholdLibraryLootTable());
        pOutput.accept(
        ...
        pOutput.accept(BuiltInLootTables.WOODLAND_MANSION, this.woodlandMansionLootTable());
        pOutput.accept(
        ...
        this.spawnerLootTables(pOutput);
    }

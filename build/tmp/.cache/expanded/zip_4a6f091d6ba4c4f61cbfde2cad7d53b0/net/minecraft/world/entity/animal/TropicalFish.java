...
public class TropicalFish extends AbstractSchoolingFish implements VariantHolder<TropicalFish.Pattern> {
    ...
    public void saveToBucketTag(ItemStack pStack) {
        ...
        CustomData.update(DataComponents.BUCKET_ENTITY_DATA, pStack, p_328762_ -> p_328762_.putInt("BucketVariantTag", this.getPackedVariant()));
    }
    ...
    public void loadFromBucketTag(CompoundTag pTag) {
        ...
        if (pTag.contains("BucketVariantTag", 3)) {
            this.setPackedVariant(pTag.getInt("BucketVariantTag"));
        }
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pSpawnType, @Nullable SpawnGroupData pSpawnGroupData) {
        ...
        if (pSpawnGroupData instanceof TropicalFish.TropicalFishGroupData tropicalfish$tropicalfishgroupdata) {
            ...
            pSpawnGroupData = new TropicalFish.TropicalFishGroupData(this, tropicalfish$variant);
        } else {
            this.isSchool = false;
    ...
    public static boolean checkTropicalFishSpawnRules(
        ...
        return pLevel.getFluidState(pPos.below()).is(FluidTags.WATER)
            ...
            && (pLevel.getBiome(pPos).is(BiomeTags.ALLOWS_TROPICAL_FISH_SPAWNS_AT_ANY_HEIGHT) || WaterAnimal.checkSurfaceWaterAnimalSpawnRules(pTropicalFish, pLevel, pSpawnType, pPos, pRandom));
    }
